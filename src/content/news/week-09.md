...
## scDBic: Deep Learning Biclustering for scRNA-seq

A novel deep learning-based biclustering algorithm specialized for single-cell RNA sequencing data enables discovery of cell groups and identification of key genes. The approach uses autoencoders to capture gene expression patterns and reverse strategy to identify key genes, improving upon traditional clustering methods.

- [scDBic paper](https://pubmed.ncbi.nlm.nih.gov/41746287/)
